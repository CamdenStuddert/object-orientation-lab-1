...
let favoriteThings = {
  ...
  movie : `The Banshee's of Inisherin`,
  holiday : `MLK Day`
}
...
favoriteThings.food = `Dino Nuggys`
...
let cat1 = new Cat(`Catriss`, 67, `White`)
...
let wiseOne = new Wizard(`Catch these Wands`, 42, `Antagonize`)
...
let iphone15 = new Phone(`Iphone`, `15`, `128GB`, `Gray`, 1000)
let galaxy8 = new Phone(`Galaxy`, `8`, `256GB`, `Black`, 600)
let pixel = new Phone(`Google`, `Pixel`, `1TB`, `Gray`, 700)
...
let fordRanger = new Vehicle(`5`, `Black`, 52000)
fordRanger.move(150)
...
let r6 = new Motorcycle(`2`, `Red`, 200, `Yamaha`)
...
let myFirstBoat = new Boat(`12`, `Black`, 0, `JollyRoger`, `Nautical`)
